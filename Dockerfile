...
# Build arguments for Chat Provider configuration
ARG NEXT_PUBLIC_CHAT_PROVIDER
ARG NEXT_PUBLIC_PIPECAT_CHAT_API_URL
ARG NEXT_PUBLIC_PIPECAT_CHAT_WS_URL

# Build arguments for Vapi configuration (server-side)
ARG VAPI_API_KEY
ARG VAPI_ASSISTANT_ID
ARG VAPI_CHAT_URL

# Set as environment variables for build process
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL
ENV NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY
ENV NEXT_PUBLIC_CHAT_PROVIDER=$NEXT_PUBLIC_CHAT_PROVIDER
ENV NEXT_PUBLIC_PIPECAT_CHAT_API_URL=$NEXT_PUBLIC_PIPECAT_CHAT_API_URL
ENV NEXT_PUBLIC_PIPECAT_CHAT_WS_URL=$NEXT_PUBLIC_PIPECAT_CHAT_WS_URL
ENV VAPI_API_KEY=$VAPI_API_KEY
ENV VAPI_ASSISTANT_ID=$VAPI_ASSISTANT_ID
ENV VAPI_CHAT_URL=$VAPI_CHAT_URL
